	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float temp_output_52_0 = (1.0 + (sin( mulTime56 ) - -1.0) * (2.0 - 1.0) / (1.0 - -1.0));
...
/*ASEBEGIN
Version=18900
1920;0;1920;1059;1941.594;217.0181;1;True;False
...
Node;AmplifyShaderEditor.TFHCRemapNode;52;-924.8243,377.7928;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;2;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=FA672A9C493A4B72C4DC9EF141F6032D55A122D9